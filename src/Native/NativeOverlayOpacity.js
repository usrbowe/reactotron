...
const NativeOverlayOpacity = props => {
  const { onChange, opacity } = props
  ...
  return (
    <div style={Styles.container}>
      <div style={Styles.row}>
        <button style={makeButtonStyle(0)} onClick={makeHandler(0)}>
          0
        </button>
        <button style={makeButtonStyle(0.1)} onClick={makeHandler(0.1)}>
          0.1
        </button>
        <button style={makeButtonStyle(0.25)} onClick={makeHandler(0.25)}>
          0.25
        </button>
        <button style={makeButtonStyle(0.5)} onClick={makeHandler(0.5)}>
          0.5
        </button>
        <button style={makeButtonStyle(0.75)} onClick={makeHandler(0.75)}>
          0.75
        </button>
        <button style={makeButtonStyle(0.9)} onClick={makeHandler(0.9)}>
          0.9
        </button>
